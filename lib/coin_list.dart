    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Text(
          label,
          style: _hiraFont.copyWith(
            color: isActive ? const Color(0xFFBF0000) : const Color(0xFF555555),
            fontSize: 14,
...
class _SparklinePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final paint = Paint()
      ...
      ..shader = ui.Gradient.linear(Offset.zero, Offset(size.width, 0), colors);
    ...
    for (int i = 0; i < data.length; i++) {
      ...
      if (i == 0) {
        ...
        final prevY = pad + drawH * (1.0 - (data[i - 1] - minVal) / range);
        final cpX = (prevX + x) / 2;
